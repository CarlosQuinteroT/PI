                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="abrirModal('categoria','registrar')" class="btn btn-secondary">
                            <i class="icon-plus"></i>&nbsp;Nuevo academia
                        </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <!-- AQUI PONDRIA UN SELECT PARA MOSTRAR LOS CONTACTOS -->
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">ID DE CONTACTO</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="id_contacto" class="form-control" placeholder="Seleccione el id del contacto">
                                    </div>
                                </div>
...
//                     me.arrayAcademia = respuesta.categorias.data;
                ...
                switch(modelo){
                    case "categoria":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Agregar/Actualizar Academia';
                                this.nombre= '';
                                this.descripcion = '';
                                this.tipoAccion = 1;
                                break;
