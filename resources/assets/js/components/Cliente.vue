                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Fecha y Hora</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="fecha_hora" class="form-control" placeholder="Fecha y Hora">
                                    </div>
                                </div>
                                 <div class="form-group row">
                ...
                switch(modelo){
                    case "persona":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar/ Actualizar Ticket';
                                this.nombre= '';
                                this.tipo_documento='DNI';
                                this.num_documento='';
                                this.direccion='';
